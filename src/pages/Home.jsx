...
function Home() {
    return (
        <div class="container py-4 center a4">
            <nav class="border-bottom pb-1 mb-4">
                <div class="row">
                    <div class="col-auto">
                        <Link href="/" class="row text-dark text-decoration-none">
                            <div class="col-auto pe-0 my-auto">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 314.587 314.587" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 314.587 314.587" width="48px" height="48px">
                                    <g>       
                            ...
                            <div class="col-auto my-auto">
                                <h1 class="display-6">Trial of Valor</h1>
                            </div>
                        </Link>
                    </div>
                    <div class="col-auto  ms-auto my-auto">
                        <Link href="/deck-preview">
            ...
            <div class="p-5 mb-4 bg-light border rounded-3">
                <div class="container-fluid py-5">
                    <h1 class="display-5 fw-bold">Hello, this is ToV companion app!</h1>
                    <p class="col-md-8 fs-4">You can choose functionality down below. GLHF</p>
                </div>
            </div>
            ...
            <div class="row align-items-md-stretch">
                <div class="col-md-6 py-2">
                    <div class="h-100 p-5 bg-light border rounded-3">
                        <h2>Game Master</h2>
                        <br />
                        <p>Provides a virtual game master to keep track of your game. This should be running on <strong>only one</strong> device!</p>
                        <br />
                        <Link href="/game-master">
                            <button class="btn btn-outline-primary">Launch GM</button>
                        </Link>
                    </div>
                </div>
                <div class="col-md-6 py-2">
                    <div class="h-100 p-5 bg-light border rounded-3">
                        ...
                        <br />
                        <p>Provides an assistant to manage your character and automate some actions. This should be running on <strong>multiple</strong> devices!</p>
                        <br />
                        <Link href="/character-manager">
                            <button class="btn btn-outline-secondary">Launch CM</button>
                        </Link>
                    </div>
                </div>
            </div>
